import 'package:fitness_tracker/common_widget/find_eat_cell.dart';
import 'package:fitness_tracker/common_widget/meal_planner_view.dart';
...
import 'package:fitness_tracker/view/Meal_planner/meal_schedule_view.dart';
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Text("Meal Nutrition's   ", style: TextStyle(
                              color: TColor.black,
                              fontSize: 15,
                          ...
                          Container(
                              ...
                              decoration: BoxDecoration(
                                gradient: LinearGradient(colors: TColor
                                    .primaryG),
                      ...
                      Container(
                        ...
                        child:Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text("Daily Meal Schedule",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 15),),
                          SizedBox(
                            height: 25,
                            width: 75,
                            child: RoundGradientButton(title: "Check", onPressed: (){
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>MealScheduleView()));
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(" Today Meals", style: TextStyle(
                              color: TColor.black,
                              fontSize: 15,
                              fontWeight: FontWeight.w700),),
                          Container(
                      ...
                      ListView.builder(
                        ...
                        itemCount: todayMealArr.length,
                          ...
                          var wObj=todayMealArr[index] as Map? ?? {};
                        return MealPlannerView(wObj: wObj);
                      }),

                      // SizedBox(height:media.width*0.05),
                      Padding(
                        padding: EdgeInsets.all(20),
                          child: Text("Find Something to Eat",style: TextStyle(fontSize: 15,fontWeight: FontWeight.w700,color: TColor.black),)),
