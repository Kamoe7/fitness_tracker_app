...
class _HomeViewState extends ConsumerState<HomeView> {
      ...
      body: SingleChildScrollView(
        child: SafeArea(
          ...
          children: [
            ...
            Container(
              ...
              child: Stack(
                children: [
                  ...
                  Padding(padding: EdgeInsets.symmetric(vertical: 25,horizontal: 25),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Column(
                          ...
                          children: [
                            Text("BMI(Body Mass Index)",style: TextStyle(color: TColor.white,fontSize: 15,fontWeight: FontWeight.w700),),
                            Text("You have a normal weight",style: TextStyle(color: Colors.white.withOpacity(1),fontSize: 12),),
                            SizedBox(height: media.width*0.05,),
                            SizedBox(
                              height: 35,
                              width: 120,
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text("Today Target",style: TextStyle(fontWeight: FontWeight.w700,fontSize: 15,color: TColor.black),),
                  SizedBox(
                    height: 25,
                    width: 75,
            ...
            SizedBox(height: media.width*0.05,),
            Text("Activity Status",style: TextStyle(fontSize: 15,fontWeight: FontWeight.w700,color: TColor.black),),
            SizedBox(height: media.width*0.05,),
              ...
              child: Container(
                ...
                child: Stack(
                  ...
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("Heart Rate",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 16
                      ),),
                      ShaderMask(
                        blendMode: BlendMode.srcIn,
                          ...
                          return LinearGradient(
                              ...
                              end: Alignment.bottomRight).createShader(Rect.fromLTRB(0, 0, bounds.width, bounds.height));
                          },
                          child:
                          Text("78 BPM",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w700,color: TColor.primaryColor1),)
                      ),
                ...
                return TouchedSpotIndicatorData(
                  ...
                  FlDotData(
                    ...
                    getDotPainter: (spot, percent, barData, index) =>
                        FlDotCirclePainter(
                          radius: 3,
                          color:Colors.white,//hello herer
                          strokeWidth: 3,
              ...
              children: [
                Expanded(
                  child: Container(
                    ...
                    child: Row(
                      children:[ SimpleAnimationProgressBar(
                        ...
                        Expanded(child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("Water Intake",style: TextStyle(color: TColor.black,fontWeight: FontWeight.w700,fontSize: 12),),
                            ShaderMask(
                                blendMode: BlendMode.srcIn,
                                shaderCallback: (bounds){
                                    ...
                                    Column(
                                      ...
                                      children:[
                                        Container(
                                          ...
                                          width: 8,
                                          height: 8,
                                          decoration: BoxDecoration(color: TColor.secondaryColor1.withOpacity(0.5),borderRadius: BorderRadius.circular(5)),
                                        ),
                                        if(!isLast)
                                        ...
                                        children: [
                                          ...
                                          ShaderMask(
                                              blendMode:BlendMode.srcIn,
                                              shaderCallback: (bounds){
                                            return LinearGradient(colors: TColor.secondaryG,
                                            begin: Alignment.centerLeft,
                                              end: Alignment.centerRight
                                            ).createShader(Rect.fromLTRB(0, 0, bounds.width, bounds.height));
                                          },
                                            child: Text(wObj['subtitle'].toString(),style: TextStyle(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ShaderMask(
                              ...
                              return LinearGradient(colors: TColor.primaryG,
                              begin: Alignment.topLeft,
                              end: Alignment.topRight).createShader(Rect.fromLTRB(0,0, bounds.width, bounds.height));
                            },
                              child: Text("8h 20m",style: TextStyle(
                                ...
                                child: Stack(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: FittedBox(
                                        child: Text("230kCal\nleft",style: TextStyle(color: TColor.white,fontSize: 11),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text("Workout Progress ",style: TextStyle(color: TColor.black,fontSize: 17,fontWeight: FontWeight.w700),),
                Container(
                  height: 30,
 ...
 ,),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
              Text("Latest Workout ",style: TextStyle(color: TColor.black,fontSize: 17,fontWeight: FontWeight.w700),),
