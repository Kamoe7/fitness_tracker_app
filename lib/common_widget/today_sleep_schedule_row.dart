...
import 'package:fitness_tracker/common/common.dart';
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          child:Image.asset(widget.sObj['image'].toString(),
          width: 40,
            height: 40,
            fit: BoxFit.contain,
            ...
            children: [
              Row(
                children: [
                  ...
                  Text(", ${getStringDateToOtherFormate(widget.sObj['time'].toString())}",
                  style: TextStyle(
                    color: TColor.black,
                    fontSize: 12
                  ),
              ...
              SizedBox(height: 8,),
              Text(widget.sObj['duration'].toString(),
              style:TextStyle(
                color: TColor.gray,
            ...
            children: [
              SizedBox(
                ...
                child: IconButton(onPressed: (){},
                    icon:Image.asset("assets/img/sub_menu.png",
                    width: 20,
                      height: 20,
                    ),
                ),
